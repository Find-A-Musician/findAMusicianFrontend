...
import GroupInvite from './GroupInviteModal';
...
export default function Card({
  ...
  const [displayGroupInviteModal, setDisplayGroupInviteModal] = useState(false);

  return (
    <>
      {displayGroupInviteModal && (
        <GroupInvite
          musician={musician}
          close={() => setDisplayGroupInviteModal(false)}
        />
      )}
          ...
          <div className="flex flex-col">
            <div className="flex items-center gap-2">
              ...
              <div className="flex items-center gap-2">
                {tagSmall}
                {isDisplayRole &&
                  getMembership(musician, group) === 'admin' && (
                ...
                {isDisplayRole &&
                  getMembership(musician, group) === 'member' && (
                    <TagSmall
                      label="member"
                      description="Appartient au groupe"
                    />
                  )}
              </div>
            </div>
